        ...
        <div class="col">
            <div class="card h-100 text-center shadow-sm border-0">
                <div class="card-body">
                    ...
                    <a href="<?= url_to('clienti_index') ?>" class="btn btn-success btn-outline-secondary">Vai ai clienti</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card h-100 text-center shadow-sm border-0">
                <div class="card-body">
                    ...
                    <a href="<?= url_to('licenze_index') ?>" class="btn btn-primary btn-outline-secondary">Vai alle licenze</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card h-100 text-center shadow-sm border-0">
                <div class="card-body">
                    ...
                    <a href="<?= url_to('versioni_index') ?>" class="btn btn-secondary btn-outline-secondary">Vai alle versioni</a>
                </div>
            </div>
        </div>
